...
void AsyncAPDS9306::setAlsGain(const APDS9306_ALS_GAIN_t again) {
  _again = again;
  _writeValue(APDS9306_CMD_ALS_GAIN, _again);
}

void AsyncAPDS9306::setAlsTime(const APDS9306_ALS_MEAS_RES_t atime) {
  _atime = atime;
  _writeValue(APDS9306_CMD_ALS_MEAS_RATE, _atime | APDS9306_ALS_MEAS_RATE_2000MS);
}
...
int AsyncAPDS9306::_powerOn() {
  return _writeValue(APDS9306_CMD_MAIN_CTRL, APDS9306_MAIN_CTRL_ALS_ENABLE);
}

int AsyncAPDS9306::_powerOff() {
  int res = _writeValue(APDS9306_CMD_MAIN_CTRL, APDS9306_MAIN_CTRL_ALS_STANDBY);
